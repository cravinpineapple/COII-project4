...
class SACFrame extends JFrame {
	...
	private Queue<Integer>[] fifoQueues = new LinkedList[8];
				...
				if (memInCacheBlock == -1){
					...
					if (!(emptyCacheBlock == -1)){ //AN EMPTY BLOCK IS AVAILABLE WITHIN THE SET
						...
						if (numWaysSel == 0){						
							...
							fifoQueues[intSetDec].add(emptyCacheBlock);
						...
						int fifoCacheBlock = fifoQueues[intSetDec].poll();
...
//							cachePanel.tag2Way[intSetDec][lruCacheBlock] = tag;	
							...
							//UPDATE THE CACHE ARRAYS KEEPING TRACK OF MEMORY BLOCKS AND TAGS													
							cachePanel.stringBlocks2Way[intSetDec][fifoCacheBlock] = ""+intBlockDecMem;
							cachePanel.tag2Way[intSetDec][fifoCacheBlock] = tag;
							
							//UPDATE THE LRU AND EMPTY STATUS OF THE BLOCK
							statusLRU++;
							statusCacheLRU2Way[intSetDec][lruCacheBlock] = statusLRU;
							
							fifoQueues[intSetDec].add(fifoCacheBlock);
...
//							cachePanel.boolWords[intWordDec] = true;
							...
							//HIGHLIGHT THE CACHE BLOCK IN YELLOW
							cachePanel.boolBlocks2Way[intSetDec][fifoCacheBlock] = true;
							cachePanel.boolWords[intWordDec] = true;
						}
...
//							cachePanel.tag4Way[intSetDec][lruCacheBlock] = tag;
							...
							//UPDATE THE CACHE ARRAYS KEEPING TRACK OF MEMORY BLOCKS AND TAGS						
							cachePanel.stringBlocks4Way[intSetDec][fifoCacheBlock] = ""+intBlockDecMem;
							cachePanel.tag4Way[intSetDec][fifoCacheBlock] = tag;
...
//							cachePanel.boolWords[intWordDec] = true;
							...
							//HIGHLIGHT THE CACHE BLOCK IN YELLOW
							cachePanel.boolBlocks4Way[intSetDec][fifoCacheBlock] = true;
							cachePanel.boolWords[intWordDec] = true;
						}
